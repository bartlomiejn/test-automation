...
public class Router: RouterProtocol {
    ...
    public init(navigator: NavigatorProtocol, moduleManager: ModuleManagerProtocol) {
        self.navigator = navigator
        self.moduleManager = moduleManager
    }
    
    public func open(_ module: ModuleProtocol.Type, parameters: StringDictionary?, callback: ((StringDictionary?) -> Void)?) {
        guard
    ...
    public func open(_ url: URL, callback: ((StringDictionary?) -> Void)?) {
